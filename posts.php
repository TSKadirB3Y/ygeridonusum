        ...
        <div class="posts-container">
            ...
            <div class="post-card" id="post-<?php echo $post['id']; ?>">
                ...
                <div class="post-actions">
                    <button type="button" class="post-action like-button <?php echo $post['is_liked'] ? 'liked' : ''; ?>" 
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.success) {
                        ...
                        showNotification(data.error || 'Beğeni işlemi sırasında bir hata oluştu.', 'error');
                    }
                },
