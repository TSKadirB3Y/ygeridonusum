...
<head>
    ...
    <title>Yaratıcı Geri Dönüşüm - Giriş Yap</title>
        ...
        <div class="login-container">
            ...
            <div class="social-login">
                ...
                <div class="social-icons">
                    <a href="#" class="facebook" title="Facebook ile giriş yap">
                        <i class="fab fa-facebook-f"></i>
                    </a>
                    <a href="#" class="google" title="Google ile giriş yap">
                        <i class="fab fa-google"></i>
                    </a>
                    <a href="#" class="twitter" title="Twitter ile giriş yap">
